...
if (isset($_POST["filename"]))
   $filename=((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], htmlsafechars($_POST["filename"])) : ((trigger_error("Error...", E_USER_ERROR)) ? "" : ""));
else
    $filename = ((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], htmlsafechars($_FILES["torrent"]["name"])) : ((trigger_error("Error...", E_USER_ERROR)) ? "" : ""));

if (isset($hash) && $hash) $url = $TORRENTSDIR . "/" . $hash . ".btf";
else $url = 0;

if (isset($_POST["info"]) && $_POST["info"]!="")
   $comment = ((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], htmlsafechars($_POST["info"])) : ((trigger_error("Error...", E_USER_ERROR)) ? "" : ""));
...
if (strlen($filename) == 0 && isset($array["info"]["name"]))
   $filename = ((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], htmlsafechars($array["info"]["name"])) : ((trigger_error("Error...", E_USER_ERROR)) ? "" : ""));

if (isset($array["comment"]))
   $info = sqlesc($array["comment"]);
else
    $info = "";
...
function endOutput()
{
 global $BASEURL, $user_id, $TRACKER_ANNOUNCEURLS;
  ...
  <script type="text/javascript" src="jscripts/TorrentName.js"></script> 
  <?php
...
<TR><TD class="header"><?php echo TORRENT_FILE ?>:</TD><TD class="lista" align="left">
  <?php
  if (function_exists("sha1"))
     echo "<INPUT TYPE='file' name='torrent' id='torrent' onchange='CopyName()'>";
  else
