...
elseif ($action=="view")
    ...
    $timeout=(60*60*24)*$days;
      ...
      $res=run_query("SELECT namemap.info_hash, filename, summary.lastspeedcycle AS lastupdate, summary.seeds, ".
    ...
    elseif (mysqli_num_rows($res)>0)
       ...
       while ($rtorrent=mysqli_fetch_array($res))
             {
        ...
        // external
         $res=run_query("SELECT namemap.info_hash, filename, UNIX_TIMESTAMP(namemap.lastupdate) AS lastupdate, summary.seeds, ".
