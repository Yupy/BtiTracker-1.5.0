...
// comments...
$subres = $db->query("SELECT comments.id, text, UNIX_TIMESTAMP(added) AS data, user, users.id AS uid FROM comments LEFT JOIN users ON comments.user = users.username WHERE info_hash = '" . $id . "' ORDER BY added DESC");
